...
public:
	...
	bool8 PreloadStreamedFile                                    (tTrack nFile, uint8 nStream = 0);
...
#endif
	int32 GetStreamedFileLength                                                   (tTrack nFile = 0);
	...
	bool8 IsUsingPs2SfxBanks(void) const;
...
static char PS2StreamedNameTable[][40] =
{
	...
	"AUDIO\\MUSIC\\KCHAT.IDSP", // 16 khz
	"AUDIO\\MUSIC\\FEVER.IDSP",
	"AUDIO\\MUSIC\\VROCK.IDSP",
	"AUDIO\\MUSIC\\VCPR.IDSP", // 16 khz
	"AUDIO\\MUSIC\\ESPANT.IDSP",
	"AUDIO\\MUSIC\\EMOTION.IDSP",
	"AUDIO\\MUSIC\\WAVE.IDSP",
	"AUDIO\\MUSIC\\MISCOM.IDSP",
	"AUDIO\\MUSIC\\CITY.IDSP",
	"AUDIO\\MUSIC\\WATER.IDSP",
	"AUDIO\\MUSIC\\BEACHAMB.IDSP",
	"AUDIO\\MUSIC\\HCITY.IDSP",
	"AUDIO\\MUSIC\\HWATER.IDSP",
	"AUDIO\\MUSIC\\HBEACH.IDSP",
	"AUDIO\\MUSIC\\MALLAMB.IDSP",
	"AUDIO\\MUSIC\\STRIP.IDSP",
	"AUDIO\\MUSIC\\MALIBU.IDSP",
	"AUDIO\\MUSIC\\HOTEL.IDSP",
	"AUDIO\\MUSIC\\DIRTRING.IDSP",
	"AUDIO\\MUSIC\\LAW4RIOT.IDSP",
	"AUDIO\\MUSIC\\AMBSIL.IDSP",
	"AUDIO\\MUSIC\\POLICE.IDSP", // 16 khz
	"AUDIO\\MUSIC\\TAXI.IDSP",
	"AUDIO\\MUSIC\\BCLOSED.IDSP",
	"AUDIO\\MUSIC\\BOPEN.IDSP",
	"AUDIO\\CUTSCENE\\ASS\\ASS_1.IDSP",
	"AUDIO\\CUTSCENE\\ASS\\ASS_2.IDSP",
	"AUDIO\\CUTSCENE\\BANK\\BANK_1.IDSP",
	"AUDIO\\CUTSCENE\\BANK\\BANK_2A.IDSP",
	"AUDIO\\CUTSCENE\\BANK\\BANK_2B.IDSP",
	"AUDIO\\CUTSCENE\\BANK\\BANK_3A.IDSP",
	"AUDIO\\CUTSCENE\\BANK\\BANK_3B.IDSP",
	"AUDIO\\CUTSCENE\\BANK\\BANK_4.IDSP",
	"AUDIO\\CUTSCENE\\BIKE\\BIKE_1.IDSP",
	"AUDIO\\CUTSCENE\\BIKE\\BIKE_2.IDSP",
	"AUDIO\\CUTSCENE\\BIKE\\BIKE_3.IDSP",
	"AUDIO\\CUTSCENE\\BUD\\BUD_1.IDSP",
	"AUDIO\\CUTSCENE\\BUD\\BUD_2.IDSP",
	"AUDIO\\CUTSCENE\\BUD\\BUD_3.IDSP",
	"AUDIO\\CUTSCENE\\CAP\\CAP_1.IDSP",
	"AUDIO\\CUTSCENE\\CAR\\CAR_1.IDSP",
	"AUDIO\\CUTSCENE\\CNT\\CNT_1A.IDSP",
	"AUDIO\\CUTSCENE\\CNT\\CNT_1B.IDSP",
	"AUDIO\\CUTSCENE\\CNT\\CNT_2.IDSP",
	"AUDIO\\CUTSCENE\\COK\\COK_1.IDSP",
	"AUDIO\\CUTSCENE\\COK\\COK_2A.IDSP",
	"AUDIO\\CUTSCENE\\COK\\COK_2B.IDSP",
	"AUDIO\\CUTSCENE\\COK\\COK_3.IDSP",
	"AUDIO\\CUTSCENE\\COK\\COK_4A.IDSP",
	"AUDIO\\CUTSCENE\\COK\\COK_4A2.IDSP",
	"AUDIO\\CUTSCENE\\COK\\COK_4B.IDSP",
	"AUDIO\\CUTSCENE\\COL\\COL_1.IDSP",
	"AUDIO\\CUTSCENE\\COL\\COL_2.IDSP",
	"AUDIO\\CUTSCENE\\COL\\COL_3A.IDSP",
	"AUDIO\\CUTSCENE\\COL\\COL_4A.IDSP",
	"AUDIO\\CUTSCENE\\COL\\COL_5A.IDSP",
	"AUDIO\\CUTSCENE\\COL\\COL_5B.IDSP",
	"AUDIO\\CUTSCENE\\CUB\\CUB_1.IDSP",
	"AUDIO\\CUTSCENE\\CUB\\CUB_2.IDSP",
	"AUDIO\\CUTSCENE\\CUB\\CUB_3.IDSP",
	"AUDIO\\CUTSCENE\\CUB\\CUB_4.IDSP",
	"AUDIO\\CUTSCENE\\DRUG\\DRUG_1.IDSP",
	"AUDIO\\CUTSCENE\\FIN\\FIN.IDSP",
	"AUDIO\\CUTSCENE\\FIN\\FIN2.IDSP",
	"AUDIO\\CUTSCENE\\FINALE\\FINALE.IDSP",
	"AUDIO\\CUTSCENE\\HAT\\HAT_1.IDSP",
	"AUDIO\\CUTSCENE\\HAT\\HAT_2.IDSP",
	"AUDIO\\CUTSCENE\\HAT\\HAT_3.IDSP",
	"AUDIO\\CUTSCENE\\ICE\\ICE_1.IDSP",
	"AUDIO\\CUTSCENE\\INT\\INT_A.IDSP",
	"AUDIO\\CUTSCENE\\INT\\INT_B.IDSP",
	"AUDIO\\CUTSCENE\\INT\\INT_D.IDSP",
	"AUDIO\\CUTSCENE\\INT\\INT_M.IDSP",
	"AUDIO\\CUTSCENE\\LAW\\LAW_1A.IDSP",
	"AUDIO\\CUTSCENE\\LAW\\LAW_1B.IDSP",
	"AUDIO\\CUTSCENE\\LAW\\LAW_2A.IDSP",
	"AUDIO\\CUTSCENE\\LAW\\LAW_2B.IDSP",
	"AUDIO\\CUTSCENE\\LAW\\LAW_2C.IDSP",
	"AUDIO\\CUTSCENE\\LAW\\LAW_3.IDSP",
	"AUDIO\\CUTSCENE\\LAW\\LAW_4.IDSP",
	"AUDIO\\CUTSCENE\\PHIL\\PHIL_1.IDSP",
	"AUDIO\\CUTSCENE\\PHIL\\PHIL_2.IDSP",
	"AUDIO\\CUTSCENE\\PORN\\PORN_1.IDSP",
	"AUDIO\\CUTSCENE\\PORN\\PORN_2.IDSP",
	"AUDIO\\CUTSCENE\\PORN\\PORN_3.IDSP",
	"AUDIO\\CUTSCENE\\PORN\\PORN_4.IDSP",
	"AUDIO\\CUTSCENE\\RESC\\RESC_1A.IDSP",
	"AUDIO\\CUTSCENE\\ROK\\ROK_1.IDSP",
	"AUDIO\\CUTSCENE\\ROK\\ROK_2.IDSP",
	"AUDIO\\CUTSCENE\\ROK\\ROK_3A.IDSP",
	"AUDIO\\CUTSCENE\\STRIPA\\STRIPA.IDSP",
	"AUDIO\\CUTSCENE\\TAX\\TAX_1.IDSP",
	"AUDIO\\CUTSCENE\\TEX\\TEX_1.IDSP",
	"AUDIO\\CUTSCENE\\TEX\\TEX_2.IDSP",
	"AUDIO\\CUTSCENE\\TEX\\TEX_3.IDSP",
	"AUDIO\\MUSIC\\GLIGHT.IDSP",
	"AUDIO\\MUSIC\\FIST.IDSP",
	"AUDIO\\MUSIC\\MISCOM.IDSP",
	"AUDIO\\MUSIC\\MISCOM.IDSP",
	"AUDIO\\MUSIC\\MISCOM.IDSP",
	"AUDIO\\MUSIC\\MISCOM.IDSP",
