...
// Chinese doesn't override Sprite[] — it uses its own ChsSprite.
// Character dispatch is handled in RenderFontBuffer, not via FONT_LOCALE.
#ifdef CHINESE_FONT
...
//#endif
	...
	static float GetChineseCharWidth(wchar c);
	static bool IsChinese() { return LanguageSet == FONT_LANGSET_CHINESE; }
