...
CMenuScreenCustom aScreens[] = {
...
#if defined(EXTERNAL_3D_SOUND) && !defined(GAMECUBE)
	...
	{ "FEH_DIS", MENUPAGE_OPTIONS, new CCustomScreenLayout({40, 78, 25, true}), nil,
		...
		DENSITY_SLIDERS
#endif
#if defined(LEGACY_MENU_OPTIONS) && !defined(GAMECUBE)
...
#ifdef CHINESE_FONT
		MENUACTION_LANG_CHI,    "FEL_CHI", {nil, SAVESLOT_NONE, MENUPAGE_LANGUAGE_SETTINGS}, 0, 0, MENUALIGN_CENTER,
#endif
		MENUACTION_GOBACK,		"FEDS_TB", {nil, SAVESLOT_NONE, MENUPAGE_NONE}, 0, 0, MENUALIGN_CENTER,
	},
