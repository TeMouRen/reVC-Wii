...
#if REAL_GAMECUBE
static bool gGcInitialiseOnceAfterRWDone = false;
#endif
...
#endif
#endif // !REAL_GAMECUBE audio restore path
#if REAL_GAMECUBE
	gGcInitialiseOnceAfterRWDone = true;
#endif
	return true;
}
...
{	
	...
	CPedStats::Shutdown();
#if REAL_GAMECUBE
	gGcInitialiseOnceAfterRWDone = false;
#endif
	CdStreamShutdown();
}
...
#if REAL_GAMECUBE
	CHud::Initialise();  // GC: deferred HUD TXD load to gameplay start
#else
	CHud::ReInitialise();
#endif
	CRadar::Initialise();
